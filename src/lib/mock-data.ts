...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: 'cat-merbau', name: 'Merbau', slug: 'merbau', description: 'Berita dari Kecamatan Merbau', order: 4, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-rangsang', name: 'Rangsang', slug: 'rangsang', description: 'Berita dari Kecamatan Rangsang', order: 5, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-rangsang-barat', name: 'Rangsang Barat', slug: 'rangsang-barat', description: 'Berita dari Kecamatan Rangsang Barat', order: 6, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-tebing-tinggi-barat', name: 'Tebing Tinggi Barat', slug: 'tebing-tinggi-barat', description: 'Berita dari Kecamatan Tebing Tinggi Barat', order: 7, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-pulau-kijang', name: 'Pulau Kijang', slug: 'pulau-kijang', description: 'Berita dari Kecamatan Pulau Kijang', order: 8, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-politik', name: 'Politik', slug: 'politik', description: 'Berita politik dan pemerintahan', order: 9, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-ekonomi', name: 'Ekonomi & Bisnis', slug: 'ekonomi-bisnis', description: 'Berita ekonomi, bisnis, dan investasi', order: 10, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-pendidikan', name: 'Pendidikan', slug: 'pendidikan', description: 'Berita pendidikan dan dunia akademik', order: 11, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-kesehatan', name: 'Kesehatan', slug: 'kesehatan', description: 'Berita kesehatan dan layanan kesehatan masyarakat', order: 12, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-infrastruktur', name: 'Infrastruktur', slug: 'infrastruktur', description: 'Berita pembangunan infrastruktur', order: 13, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-budaya', name: 'Budaya', slug: 'budaya', description: 'Berita kebudayaan dan kesenian Melayu', order: 14, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-pariwisata', name: 'Pariwisata', slug: 'pariwisata', description: 'Berita pariwisata dan destinasi wisata', order: 15, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-olahraga', name: 'Olahraga', slug: 'olahraga', description: 'Berita olahraga dan prestasi atlet', order: 16, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-teknologi', name: 'Teknologi', slug: 'teknologi', description: 'Berita teknologi dan digital', order: 17, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-sosial', name: 'Sosial', slug: 'sosial', description: 'Berita sosial dan kemasyarakatan', order: 18, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-hukum', name: 'Hukum & Kriminal', slug: 'hukum-kriminal', description: 'Berita hukum dan keamanan', order: 19, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-lingkungan', name: 'Lingkungan', slug: 'lingkungan', description: 'Berita lingkungan hidup dan kelestarian alam', order: 20, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-opini', name: 'Opini', slug: 'opini', description: 'Opini dan kolom penulis', order: 21, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
  { id: 'cat-nasional', name: 'Nasional', slug: 'nasional', description: 'Berita nasional yang relevan', order: 22, articleCount: 0, createdAt: daysAgo(90), updatedAt: daysAgo(1) },
];
