      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Buat berita baru.</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          {saveStatus === 'saving' && (
          ...
          <div className="relative">
            ...
            {showLinkInput && (
              <div className="absolute top-full left-0 mt-1 flex gap-1 rounded-md border bg-background p-2 shadow-md z-50">
                ...
                />
                <Button type="button" size="sm" className="h-8" onClick={handleAddLink}>
                  OK
                </Button>
              </div>
            )}
          ...
          <div className="relative">
            ...
            {showImageInput && (
              <div className="absolute top-full left-0 mt-1 flex gap-1 rounded-md border bg-background p-2 shadow-md z-50">
                ...
                />
                <Button type="button" size="sm" className="h-8" onClick={handleAddImage}>
                  OK
                </Button>
              </div>
            )}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <Checkbox
                id="breaking"
                checked={breaking}
                onCheckedChange={(v) => setBreaking(!!v)}
              />
